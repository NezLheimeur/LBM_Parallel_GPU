                 ...
                 real_t* uy)
{
  ...
  #pragma acc parallel present(ux, uy, fin, rho)
  {
                 ...
                 real_t* feq)
{
  ...
  #pragma acc parallel present(ux, uy, feq, rho)
  {
          #pragma acc loop gang
	  for (int j = 0; j < ny; ++j) {
    		  #pragma acc loop vector
...
void init_obstacle_mask(const LBMParams& params, int* obstacle)
{
  ...
  #pragma acc parallel present(obstacle)
  {  
  	 #pragma acc loop gang 
	 for (int j = 0; j < ny; ++j) {
    		#pragma acc loop vector
                                      ...
                                      real_t* uy)
{
  ...
  #pragma acc parallel present(rho, ux, uy)
  {
	#pragma acc loop  gang
  	for (int j = 0; j < ny; ++j) {
		#pragma acc loop vector
...
void border_outflow(const LBMParams& params, real_t* fin)
{
  ...
  #pragma acc parallel present(fin)
  {
	 #pragma acc loop 
	 for (int j=0; j<ny; ++j) {
                   ...
                   real_t* rho, real_t* ux, real_t* uy)
{
  ...
  const int i = 0;
  #pragma acc parallel present(ux, uy, rho, fin)
  {
	#pragma acc loop
  	for (int j = 0; j < ny; ++j) {
                       ...
                       real_t* fin)
{
  ...
  const int i = 0;
  #pragma acc parallel present(feq, fin)
  {
	#pragma acc loop 
  	for (int j = 0; j < ny; ++j) {
                       ...
                       real_t* fout)
{
  ...
  #pragma acc parallel present(fin, feq, fout)
  {
  	  #pragma acc loop gang
	  for (int j = 0; j < ny; ++j) {
    		  #pragma acc loop vector
                     ...
                     real_t* fout)
{
  ...
  const int nxny = nx*ny;
  const int npop = LBMParams::npop;
  #pragma acc parallel present(fin, fout, obstacle)
  {
	#pragma acc loop gang
  	for (int j = 0; j < ny; ++j) {
		#pragma acc loop vector
               ...
               real_t* fin)
{
  ...
  #pragma acc parallel present(fin, fout)
  {
	#pragma acc loop gang
  	for (int j = 0; j < ny; ++j) {
		#pragma acc loop vector
